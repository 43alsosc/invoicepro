  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!customerId || !amount || !status) {
      setState({
        message: '',
        errors: {
          id: !customerId ? ['Customer is required'] : [],
    ...
    const newState = await createInvoice(state, formData);
    setState(newState);
    console.log(createInvoice(state, formData))
  }
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                type="number"
                step="0.01"
                placeholder="Enter USD amount (>0.00)"
            ...
            <div className="flex gap-4">
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="pending"
                  className="h-4 w-4 cursor-pointer border-gray-300 bg-gray-100 text-black focus:ring-2 focus:ring-gray-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-gray-600"
                />
                <label
                  htmlFor="pending"
                  className="ml-2 flex cursor-pointer items-center gap-1.5 rounded-full bg-gray-100 px-3 py-1.5 text-xs font-medium text-black dark:text-gray-300"
                >
              ...
              <div className="flex items-center">
                ...
                >
                  Overdue <CheckIcon className="h-4 w-4" />
                </label>
              </div>
